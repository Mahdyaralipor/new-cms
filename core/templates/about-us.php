                      ...
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex items-start space-x-3">
                          ...
                          <div class="min-w-0 flex-1 py-0">
                            <div class="text-md text-gray-500">
                              <div>
                                <span class="font-medium text-gray-900 mr-2">استخدام نیرو</span>
                      ...
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex items-start space-x-3">
                          ...
                          <div class="min-w-0 flex-1 py-0">
                            <div class="text-md text-gray-500">
                              <div>
                                <span class="font-medium text-gray-900 mr-2">جذب هزار کاربر اولیه</span>
