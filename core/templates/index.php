            ...
            <div class="grid grid-cols-12 gap-8">
                <div class="col-span-12 md:col-span-5 relative">
                    <div class="leading-8">
                        ...
                        <div class="flex justify-end">
                            <a href="login" class="mt-4 py-1 px-7 rounded-full bg-orange-200 hover:duration-300 font-YekanBakh-SemiBold">بیشتر بخوانید...</a>
            ...
            <div class="mx-auto px-4 lg:px-0 max-w-md sm:max-w-3xl lg:max-w-7xl">
                <div class="relative rounded-3xl px-6 py-10 bg-stone-800 overflow-hidden shadow-xl sm:px-12 sm:py-16">
                    ...
                    <div class="relative flex flex-col">
                        ...
                        <a href="contact-us" class="w-auto inline-block mt-5 mx-auto py-2 px-7 rounded-full bg-orange-200 hover:duration-300 font-YekanBakh-SemiBold">ارتباط با کارشناسان</a>
                    </div>
                </div>
            </div>
        </div>
